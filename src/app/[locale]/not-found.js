  ...
  return (
    <>
      ...
      <main className="flex-1 flex items-center">
        <div className="max-w-[640px] w-full mx-auto my-10 px-6">
          <div
            className="
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                href="/"
                className="
                  inline-block w-full sm:w-auto px-6 py-3 rounded-md font-semibold no-underline
                  text-[#3d3300]
              ...
              <Link
                ...
                className="
                  inline-block w-full sm:w-auto px-6 py-3 rounded-md font-semibold no-underline
                  text-[var(--bg-color-header)] bg-white border border-[#c3a421]/30
                  hover:bg-[#fff8dc] transition-all duration-300
                "
              >
                {t("browseQuestions")}
              </Link>
